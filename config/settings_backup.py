...
class TradingConfig:
    ...
    def __init__(self):
        ...
        # ATR配置
        self.ATR_PERIOD = int(os.getenv("ATR_PERIOD", "14"))
        self.ATR_TIMEFRAME = os.getenv("ATR_TIMEFRAME", "1m")
        self.ATR_MULTIPLIER = float(os.getenv("ATR_MULTIPLIER", "2.0"))  # 参考Pine Script设置为2.0
